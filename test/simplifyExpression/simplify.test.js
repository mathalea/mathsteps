...
describe('distribution', function () {
  const tests = [
    ['(3*x)*(4*x)', '12 x ^ 2'],
    ['(3+x)*(4+x)*(x+5)', 'x ^ 3 + 12 x ^ 2 + 47 x + 60'],
...
describe('keeping parens in important places, on printing', function() {
  testSimplify('2 / (3x^2) + 5', '2 / (3 x ^ 2) + 5');
});
